...
void AddDescriptors();
void InitDefaultsLinearBooleanConstraintImpl();
void InitDefaultsLinearBooleanConstraint();
void InitDefaultsLinearObjectiveImpl();
void InitDefaultsLinearObjective();
void InitDefaultsBooleanAssignmentImpl();
void InitDefaultsBooleanAssignment();
void InitDefaultsLinearBooleanProblemImpl();
void InitDefaultsLinearBooleanProblem();
inline void InitDefaults() {
  InitDefaultsLinearBooleanConstraint();
  InitDefaultsLinearObjective();
  InitDefaultsBooleanAssignment();
  InitDefaultsLinearBooleanProblem();
}
}  // namespace protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto
...
class LinearBooleanConstraint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.LinearBooleanConstraint) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::InitDefaultsLinearBooleanConstraintImpl();
};
// -------------------------------------------------------------------
...
class LinearObjective : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.LinearObjective) */ {
 ...
 private:
  ...
  friend struct ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::InitDefaultsLinearObjectiveImpl();
};
// -------------------------------------------------------------------
...
class BooleanAssignment : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.BooleanAssignment) */ {
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::int32 > literals_;
  friend struct ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::InitDefaultsBooleanAssignmentImpl();
};
// -------------------------------------------------------------------
...
class LinearBooleanProblem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.LinearBooleanProblem) */ {
 ...
 private:
  ...
  friend struct ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fsat_2fboolean_5fproblem_2eproto::InitDefaultsLinearBooleanProblemImpl();
};
// ===================================================================
