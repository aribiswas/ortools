...
void AddDescriptors();
void InitDefaultsFirstSolutionStrategyImpl();
void InitDefaultsFirstSolutionStrategy();
void InitDefaultsLocalSearchMetaheuristicImpl();
void InitDefaultsLocalSearchMetaheuristic();
inline void InitDefaults() {
  InitDefaultsFirstSolutionStrategy();
  InitDefaultsLocalSearchMetaheuristic();
}
}  // namespace protobuf_ortools_2fconstraint_5fsolver_2frouting_5fenums_2eproto
...
class FirstSolutionStrategy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.FirstSolutionStrategy) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fenums_2eproto::InitDefaultsFirstSolutionStrategyImpl();
};
// -------------------------------------------------------------------
...
class LocalSearchMetaheuristic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.LocalSearchMetaheuristic) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fenums_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fenums_2eproto::InitDefaultsLocalSearchMetaheuristicImpl();
};
// ===================================================================
