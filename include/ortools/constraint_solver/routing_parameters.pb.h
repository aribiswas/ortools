...
void AddDescriptors();
void InitDefaultsRoutingSearchParameters_LocalSearchNeighborhoodOperatorsImpl();
void InitDefaultsRoutingSearchParameters_LocalSearchNeighborhoodOperators();
void InitDefaultsRoutingSearchParametersImpl();
void InitDefaultsRoutingSearchParameters();
void InitDefaultsRoutingModelParametersImpl();
void InitDefaultsRoutingModelParameters();
inline void InitDefaults() {
  InitDefaultsRoutingSearchParameters_LocalSearchNeighborhoodOperators();
  InitDefaultsRoutingSearchParameters();
  InitDefaultsRoutingModelParameters();
}
}  // namespace protobuf_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto
...
class RoutingSearchParameters_LocalSearchNeighborhoodOperators : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters.LocalSearchNeighborhoodOperators) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto::InitDefaultsRoutingSearchParameters_LocalSearchNeighborhoodOperatorsImpl();
};
// -------------------------------------------------------------------
...
class RoutingSearchParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.RoutingSearchParameters) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto::InitDefaultsRoutingSearchParametersImpl();
};
// -------------------------------------------------------------------
...
class RoutingModelParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.RoutingModelParameters) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2frouting_5fparameters_2eproto::InitDefaultsRoutingModelParametersImpl();
};
// ===================================================================
