...
void AddDescriptors();
void InitDefaultsSearchLimitParametersImpl();
void InitDefaultsSearchLimitParameters();
inline void InitDefaults() {
  InitDefaultsSearchLimitParameters();
}
}  // namespace protobuf_ortools_2fconstraint_5fsolver_2fsearch_5flimit_2eproto
...
class SearchLimitParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.SearchLimitParameters) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2fsearch_5flimit_2eproto::InitDefaultsSearchLimitParametersImpl();
};
// ===================================================================
