...
void AddDescriptors();
void InitDefaultsDemonRunsImpl();
void InitDefaultsDemonRuns();
void InitDefaultsConstraintRunsImpl();
void InitDefaultsConstraintRuns();
inline void InitDefaults() {
  InitDefaultsDemonRuns();
  InitDefaultsConstraintRuns();
}
}  // namespace protobuf_ortools_2fconstraint_5fsolver_2fdemon_5fprofiler_2eproto
...
class DemonRuns : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.DemonRuns) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2fdemon_5fprofiler_2eproto::InitDefaultsDemonRunsImpl();
};
// -------------------------------------------------------------------
...
class ConstraintRuns : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.ConstraintRuns) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ortools_2fconstraint_5fsolver_2fdemon_5fprofiler_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2fdemon_5fprofiler_2eproto::InitDefaultsConstraintRunsImpl();
};
// ===================================================================
