...
void AddDescriptors();
void InitDefaultsConstraintSolverParametersImpl();
void InitDefaultsConstraintSolverParameters();
inline void InitDefaults() {
  InitDefaultsConstraintSolverParameters();
}
}  // namespace protobuf_ortools_2fconstraint_5fsolver_2fsolver_5fparameters_2eproto
...
class ConstraintSolverParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.ConstraintSolverParameters) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fconstraint_5fsolver_2fsolver_5fparameters_2eproto::InitDefaultsConstraintSolverParametersImpl();
};
// ===================================================================
