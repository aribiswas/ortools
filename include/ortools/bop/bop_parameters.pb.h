...
void AddDescriptors();
void InitDefaultsBopOptimizerMethodImpl();
void InitDefaultsBopOptimizerMethod();
void InitDefaultsBopSolverOptimizerSetImpl();
void InitDefaultsBopSolverOptimizerSet();
void InitDefaultsBopParametersImpl();
void InitDefaultsBopParameters();
inline void InitDefaults() {
  InitDefaultsBopOptimizerMethod();
  InitDefaultsBopSolverOptimizerSet();
  InitDefaultsBopParameters();
}
}  // namespace protobuf_ortools_2fbop_2fbop_5fparameters_2eproto
...
class BopOptimizerMethod : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopOptimizerMethod) */ {
 ...
 private:
  ...
  friend void ::protobuf_ortools_2fbop_2fbop_5fparameters_2eproto::InitDefaultsBopOptimizerMethodImpl();
};
// -------------------------------------------------------------------
...
class BopSolverOptimizerSet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopSolverOptimizerSet) */ {
 ...
 private:
  ...
  friend struct ::protobuf_ortools_2fbop_2fbop_5fparameters_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fbop_2fbop_5fparameters_2eproto::InitDefaultsBopSolverOptimizerSetImpl();
};
// -------------------------------------------------------------------
...
class BopParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.bop.BopParameters) */ {
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_ortools_2fbop_2fbop_5fparameters_2eproto::TableStruct;
  friend void ::protobuf_ortools_2fbop_2fbop_5fparameters_2eproto::InitDefaultsBopParametersImpl();
};
// ===================================================================
...
inline void BopParameters::clear_default_solver_optimizer_sets() {
  default_solver_optimizer_sets_.ClearToDefaultNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get());
...
inline void BopParameters::set_default_solver_optimizer_sets(const ::std::string& value) {
  ...
  default_solver_optimizer_sets_.SetNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get(), value);
...
inline void BopParameters::set_default_solver_optimizer_sets(::std::string&& value) {
  ...
  default_solver_optimizer_sets_.SetNoArena(
    &::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get(), ::std::move(value));
...
inline void BopParameters::set_default_solver_optimizer_sets(const char* value) {
  ...
  set_has_default_solver_optimizer_sets();
  default_solver_optimizer_sets_.SetNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get(), ::std::string(value));
...
inline void BopParameters::set_default_solver_optimizer_sets(const char* value, size_t size) {
  set_has_default_solver_optimizer_sets();
  default_solver_optimizer_sets_.SetNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get(),
...
inline ::std::string* BopParameters::mutable_default_solver_optimizer_sets() {
  ...
  return default_solver_optimizer_sets_.MutableNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get());
}
inline ::std::string* BopParameters::release_default_solver_optimizer_sets() {
  ...
  clear_has_default_solver_optimizer_sets();
  return default_solver_optimizer_sets_.ReleaseNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get());
}
inline void BopParameters::set_allocated_default_solver_optimizer_sets(::std::string* default_solver_optimizer_sets) {
  ...
  default_solver_optimizer_sets_.SetAllocatedNoArena(&::operations_research::bop::BopParameters::_default_default_solver_optimizer_sets_.get(), default_solver_optimizer_sets);
